...
# from .utils import is_camera_reachable , is_camera_streaming , is_serial_device_available
...
class WeightCard(models.Model):
    ...
    company = models.ForeignKey(Company, on_delete=models.CASCADE, verbose_name="الشركه")
